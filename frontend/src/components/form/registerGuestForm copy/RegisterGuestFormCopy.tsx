...
import { CategoryHeader, CostumDatePicker, FormContainer, Line, RegisterButton, TermsWrapper, TextfieldLong, WarningBox } from './registerGuestFormCopy.Styles'
import { Checkbox, Fade } from '@mui/material'
import { TypoBody2, TypoH2, TypoWarning } from '../../../styled-components/styledTypographie'
import { boxShadowAnimation } from './registerGuestFormCopy.Styles'
